      ...
      <SafeAreaView style={{flexDirection: 'row', justifyContent: 'flex-start', justifyContent: 'center', width:'100%'}}>
        ...
        <TouchableOpacity onPress={()=> navigation.navigate("HomBasico")}>
            <SafeAreaView style={styles.box}>
                <Image style={styles.image} source={require('../assets/espaldabasico.png')} />
                <Text style={{fontSize: 20, color: 'black', marginTop:-40}}>Nivel Básico</Text>
            </SafeAreaView>
        </TouchableOpacity>

        <TouchableOpacity onPress={()=> navigation.navigate("HomAvanzado")}>
            <SafeAreaView style={styles.box}>
                <Image style={styles.image} source={require('../assets/espaldaavanzado.png')} />
